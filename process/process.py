...
class Process(IO):
    ...
    def load_data(self):
        ...
        if 'debug' not in self.arg.eval_feeder_args:
            self.arg.eval_feeder_args['debug'] = self.arg.debug
    ...
    def get_parser(add_help=False):
        ...
        # processor
        parser.add_argument('--phase', default='test', help='to test the network')
        ...
        parser.add_argument('--eval_feeder_args', action=DictAction, default=dict(), help='the arguments of data loader for eval')
